                                ...
                                @foreach($result as $key=> $data)
                                    @if($data->question->question)
                                         <div class="col-md-12" style="background-color: white;">
                                            @if($data->question->questionType->name != 'Essay')
                                            ...
                                            @elseif($data->question->questionType->name == 'Essay')
                                                ...
                                                <br>
                                                @if(Auth::user()->userType->name == 'Teacher')
                                                    <input type="number" id="a-point" name="apoint[]" class="apoint form-control geo-border-primary" required placeholder="Enter score." value="{{$data->apoint ?? 0}}" style="width:30%; height:50px;">
                                                @else
                                                    <input type="text" class="apoint form-control geo-border-primary" readonly value="{{$data->apoint ?? 'Score is not yet availble- 0'}} point/s" style="width:30%; height:50px;" placeholder="">
                                                @endif
                                                <br>
