                    ...
                    <div class="row col-md-12">
                        ...
                        @if(count($section->sectionTeacher) > 0)
                            ...
                            @if($section->sectionTeacher[0]->assign_prev == 1)
                                <a href="/sections/subjects/assessment/assigned/assessement/{{$section->id}}/{{$subject->id}}/{{$assessment->id ?? ''}}" data-toggle="tooltip" title="Assign Assessment" class="action-btn btn  text-light mb-1" style="background-color: white;color: black !important; margin-top: -4px;margin-left: -10px;">
