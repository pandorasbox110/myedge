                                                ...
                                                <div class="text-center" style="padding: 10px;">
                                                    ...
                                                    @if(Auth::user()->userType->name == 'Teacher' ||Auth::user()->userType->name == 'Institute Admin')
                                                        ...
                                                        @else
                                                            ...
                                                            @endif
                                                        @endif
                                                        <a href="/sections/subjects/report/{{$section->id}}/{{$result->id}}" data-toggle="tooltip" title="View Grades " class="action-btn btn text-light mb-1" style="background-color:#37cf30;">
