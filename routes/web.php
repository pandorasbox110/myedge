...
Route::post('/sections/subjects/assessment/unassign/assessement/store', 'SectionsController@unassignAssessmentStore');
//student
...
//ebook
Route::get('/databaseedit', 'SectionsController@databaseEdit');
